...
ExpTimeChart.prototype.updateVis = function (){
    ...
    function lines() {
        ...
        var counter = 0;
        function draw(k) {
            console.log("k: ", k, "counter: ",counter);
            ...
            console.log("len of l8 data: ",new_dt_L8.length);
            console.log(new_dt_L8[k-counter]);
            ...
            //         .attr("transform", function(d) { return "translate(" + jProg.x(d.date) + "," + jProgy(d.height + 200) + ")"; });
            // });
        }
